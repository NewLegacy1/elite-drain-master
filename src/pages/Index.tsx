...
const Index = () => {
  // Use current origin so shared links and canonical match where the site is actually hosted (Vercel vs custom domain)
  const siteUrl = typeof window !== "undefined" ? window.location.origin : "https://jaythatdrainguy.com";
  ...
  return (
    <>
      <Helmet>
        ...
        {/* Open Graph - use current origin so shares show the URL you're actually on (Vercel or custom domain) */}
        ...
        {/* Canonical - matches current host so SEO and shares use the right domain */}
